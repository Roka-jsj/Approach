...
빌드 중 `yolo_msgs` Python import까지 검사하므로, 런타임에 `ModuleNotFoundError: No module named yolo_msgs`가 나면 이전 이미지 태그를 실행 중인지 먼저 확인하세요.
